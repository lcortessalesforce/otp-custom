...
This is a sample OTP application deployed to Heroku.
...
```sh
$ git clone https://github.com/lcortessalesforce/otp-custom.git # or clone your own fork
$ cd otp-custom
$ npm install
$ npm start
```
...
You can integrate it by this request
- POST /generate